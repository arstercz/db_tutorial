...
struct Cursor_t {
  ...
  uint32_t page_num;
  uint32_t cell_num;
  bool end_of_table; // Indicates a position one pas the past element
};
...
#define COMMON_NODE_HEADER_SIZE (NODE_TYPE_SIZE + \
...
void print_constants() {
  ...
  printf("LEAF_NODE_SPACE_CELLS: %d\n", LEAF_NODE_SPACE_FOR_CELLS);
...
void internal_node_insert(Table* table, uint32_t parent_page_num,
  ...
  /*
   Add a new child/key pair to parent taht corresponds to child
  */
